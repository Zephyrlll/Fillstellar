...
export const celestialObjectPools = {
    ...
    getMaterial(type, properties = {}) {
        ...
        switch (type) {
            case 'star':
                return new THREE.MeshStandardMaterial(Object.assign({ emissive: new THREE.Color(0xff4444), emissiveIntensity: 0.3 }, properties));
            case 'planet':
                return new THREE.MeshStandardMaterial(Object.assign({ roughness: 0.8, metalness: 0.2 }, properties));
            case 'lifeAura':
                return new THREE.MeshBasicMaterial(Object.assign({ color: 0x00ff00, transparent: true, opacity: 0.15, blending: THREE.AdditiveBlending }, properties));
            default:
