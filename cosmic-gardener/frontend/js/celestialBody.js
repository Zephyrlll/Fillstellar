...
import { celestialObjectPools } from './utils.js';
...
export function createCelestialBody(type, options = {}) {
    ...
    if (!result.ok) {
        ...
        const fallbackMesh = new THREE.Mesh(new THREE.SphereGeometry(1, 32, 32), new THREE.MeshStandardMaterial({ color: 0xff00ff }));
